...
<html>
	...
	<body>
		<div id="fh5co-offcanvas">
			...
			<div class="fh5co-bio">
				<figure>
					<img src="${pageContext.request.contextPath }/resources/images/person1.jpg" alt="Free HTML5 Bootstrap Template"
		...
		<div class="container-fluid">
			<div class="row fh5co-post-entry">
				<article
					...
					<span class="fh5co-meta"><a href="details">Teknoloji</a></span>
					<h2 class="fh5co-article-title">
						<a href="details">Blog Başlığı</a>
					</h2>
					<h3>
						<a href="details" style="color: #999999">Lorem ipsum dolor
