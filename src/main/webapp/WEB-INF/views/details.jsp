...
<html>
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			<figure>
				<img src="${pageContext.request.contextPath }/resources/images/person1.jpg" alt="Free HTML5 Bootstrap Template" class="img-responsive">
			</figure>
			<h3 class="heading">About Me</h3>
				<h2>Tutku Ince</h2>
				<p>Hi! I am Tutku. I am a computer engineer and working as a java developer.</p>
